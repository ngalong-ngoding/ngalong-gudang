...
require_once "./controllers/AryaController.php";
...
$aryaController = new AryaController();
...
$routes = [
    ...
    "arya" => [$aryaController, "index"],
    "arya/store" => [$aryaController, "store"],
    "arya/delete" => [$aryaController, "delete"],
    "arya/edit" => [$aryaController, "edit"],
];
