    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10 p-4">
                <p class="fs-1">Nama saya Michael</p>
                <p class="fs-3">Game kesukaan saya:</p>
                <div class="list-group mb-4">
                    <?php foreach ($michael->getAllGames() as $game): ?>
                        <li class="list-group-item">
                            <form method="POST" action=<?php echo "?route=michael/edit&id=$game[id]" ?> class="d-flex justify-content-between align-items-center mb-0">
                                <?php
                                ...
                                ?>
                                <div>
                                    <?php echo "<a class='btn btn-danger' href='?route=michael/delete&id=$game[id]'>Delete</a>" ?>
                ...
                <form method="POST" action="?route=michael/store" class="d-flex gap-1 justify-content-end">
